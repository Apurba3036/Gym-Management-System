                                                    ...
                                                    >
                                                        ...
                                                        <td className="whitespace-nowrap px-6 py-4">
                                                            <div className="flex gap-2">
                                                                ...
                                                                <button onClick={() => navigate(`/dashboard/updatepackageadmin/${Pac._id}`)} className='px-3 bg-green-500 font-bold py-1 text-white w-full my-3 rounded-lg'>View Details</button>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                ))
